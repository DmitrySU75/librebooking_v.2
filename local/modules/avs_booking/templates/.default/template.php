...
<style>
.avs-booking-module { background: #f5f5f5; padding: 20px; border-radius: 12px; margin: 20px 0; }
.avs-booking-module .form-group { margin-bottom: 15px; }
.avs-booking-module label { display: block; margin-bottom: 5px; font-weight: 600; }
.avs-booking-module .form-control { width: 100%; padding: 8px 12px; border: 1px solid #ddd; border-radius: 6px; box-sizing: border-box; }
.avs-booking-module select.form-control { width: auto; }
.avs-booking-module .booking-submit-btn { background: #2e7d32; color: white; padding: 10px 20px; border: none; border-radius: 6px; cursor: pointer; font-size: 16px; width: 100%; }
.avs-booking-module .booking-submit-btn:hover { background: #1b5e20; }
.avs-booking-module .rental-type-radios { margin-top: 5px; }
.avs-booking-module .rental-radio { width: auto !important; margin-right: 5px; display: inline-block !important; }
.avs-booking-module .radio-option { display: flex; align-items: center; margin-bottom: 8px; }
.avs-booking-module .radio-option label { margin-bottom: 0; font-weight: normal; cursor: pointer; }
.warning-message { padding: 8px; background: #fff3e0; border-radius: 4px; margin-top: 5px; }
</style>
